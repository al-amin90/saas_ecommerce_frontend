...
import {
  ...
  Button, Drawer, List, ListItem, ListItemText, Container,
  TextField, InputAdornment, Divider, Collapse
} from '@mui/material';
...
export default function Navbar({ cartCount = 0, wishlistCount = 0 }) {
  ...
  return (
    <>
      ...
      >
        Free Delivery on Orders Over ৳3000 &nbsp;|&nbsp; Use Code: <strong>SOLE2025</strong> for 10% Off
      </Box>
      ...
      >
        <Container maxWidth="xl">
          <Toolbar sx={{ py: 1, px: { xs: 0, md: 0 }, minHeight: { xs: 64, md: 72 } }}>
            {/* Logo */}
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mr: 4 }}>
              ...
              >
                <Typography sx={{ color: '#C8A97E', fontSize: '1.2rem', lineHeight: 1 }}>
                  S
                </Typography>
              </Box>
              <Typography
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, ml: 'auto' }}>
              ...
              <IconButton
                size="small"
                sx={{ color: '#1A1A1A', '&:hover': { color: '#C8A97E' }, display: { xs: 'none', sm: 'flex' } }}
              >
